//! This crate is not meant to be used on its own. This crate contains
//! the under the hood procedural macros to autogenerate
...
mod tests {
    ...
    fn test_fft_type() {
        ...
        assert_eq!(FFTType::compute_type(27), FFTType::Coprime);
